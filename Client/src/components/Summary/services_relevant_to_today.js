...
export default function ServiceList(props) {
  ...
  useEffect(() => {
    ...
    if (tokenObject) {
      ...
      axios
        .get("/service/getServicesRelevantToToday", {
          headers: {
        ...
        .then((res) => {
          if (res.data.success) {
            ...
            setNumberOfServices(res.data.number_of_services);
            setTotalPrice(res.data.total_price);
            setDiscountedAmount(res.data.discounted_amount);
          } else {
            setMessage({
              status: true,
              success: false,
    ...
    <div className="wrapper my-custom-scrollbar my-custom-scrollbar-primary">
      ...
      <div id="content">
        <div className="container">
          ...
          <div className="row">
            <div className="col">
              <h2>Services relevant to today</h2>
            </div>
          </div>
          <div className="row">
            <div className="col">
