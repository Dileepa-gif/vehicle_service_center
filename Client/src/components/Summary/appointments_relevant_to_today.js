...
export default function AppointmentList(props) {
  ...
  useEffect(() => {
    ...
    if (tokenObject) {
      ...
      axios
        .get("/appointment/getAppointmentsRelevantToToday", {
          headers: {
        ...
        .then((res) => {
          if (res.data.success) {
            ...
            setArrivedCount(res.data.arrived_count);
            setReservedCount(res.data.reserved_count);
          } else {
            setMessage({
              status: true,
              success: false,
    ...
    <div className="wrapper">
      ...
      <div id="content">
        <div className="container">
          ...
          <div className="row">
            <div className="col">
              <h2>Appointments relevant to today</h2>
            </div>
          </div>
          <div className="row">
            <div className="col">
          ...
          <div className="row">
            <div className="col">
              <p>Arrived appointments count = {arrivedCount}</p>
              <p>Reserved appointments count = {reservedCount}</p>
            </div>
          </div>
